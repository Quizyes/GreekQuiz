...
query = "SELECT * FROM morphs ORDER BY lesson;"
rows = []
...
for entry in rows:
    ...
    print("st.bind(1, \"{}\");".format(entry["inflected"]))
    print("st.bind(2, \"{}\");".format(entry["head"]))
    print("st.bind(3, \"{}\");".format(entry["parse"]))
    print("st.bind(4, {});".format(entry["lesson"]))
    print("st.exec(); \nst.reset(); \nst.clearBindings();")
